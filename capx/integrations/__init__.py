...
from .franka.two_arm_peg_in_hole_privileged import FrankaTwoArmPegInHolePrivilegedApi
...
register_api("FrankaTwoArmPegInHolePrivilegedApi", FrankaTwoArmPegInHolePrivilegedApi)
register_api(
